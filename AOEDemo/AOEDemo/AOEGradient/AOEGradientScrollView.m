...
@interface AOEGradientScrollView ()

@property (nonatomic, assign) AOEGradientDirection direction;

@end

@implementation AOEGradientScrollView

+(instancetype)gradientTableViewWithFrame:(CGRect)frame Direction:(AOEGradientDirection)direction GradientValues:(AOEGradientValues)gradientValues{
    
    return [[self alloc] initWithFrame:frame Direction:direction GradientValues:gradientValues];
}

-(instancetype)initWithFrame:(CGRect)frame Direction:(AOEGradientDirection)direction GradientValues:(AOEGradientValues)gradientValues{
